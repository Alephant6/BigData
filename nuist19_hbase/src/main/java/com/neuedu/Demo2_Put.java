...
//            byte[] rk = Bytes.toBytes("1001");//行键
//            byte[] family = Bytes.toBytes("info");//列族
//            byte[] c1 = Bytes.toBytes("name");//列
//            byte[] v1 = Bytes.toBytes("张三");//单元格的值
//            byte[] c2 = Bytes.toBytes("sex");//列
//            byte[] v2 = Bytes.toBytes("男");//单元格的值
//            byte[] c3 = Bytes.toBytes("age");//列
//            byte[] v3 = Bytes.toBytes(22);//单元格的值
...
//            byte[] v3 = Bytes.toBytes(33);//单元格的值
            ...
            byte[] rk = Bytes.toBytes("1003");//行键
            byte[] family = Bytes.toBytes("info");//列族
            byte[] c1 = Bytes.toBytes("name");//列
            byte[] v1 = Bytes.toBytes("王五");//单元格的值
            byte[] c2 = Bytes.toBytes("sex");//列
            byte[] v2 = Bytes.toBytes("女");//单元格的值
            byte[] c3 = Bytes.toBytes("age");//列
            byte[] v3 = Bytes.toBytes(28);//单元格的值
            // 实例化Put对象
            Put put = new Put(rk);
            // 添加列值
